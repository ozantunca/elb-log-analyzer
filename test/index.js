  ...
  describe('cli mode', function () {
    ...
    it('custom column client and backend IPs w/o port', function (done) {
      async.parallel([
        ...
        // stdout
        assert.equal(results[0][0], '1 - 126 - 216.137.60.6\n2 - 78 - 54.239.167.74\n3 - 60 - 216.137.58.48\n4 - 57 - 95.7.142.5\n5 - 54 - 77.92.102.34\n6 - 36 - 54.239.171.99\n7 - 36 - 205.251.252.16\n8 - 33 - 54.240.156.59\n9 - 33 - 88.246.209.164\n10 - 33 - 95.14.129.124\n')
        assert.equal(results[1][0], '1 - 1245 - 10.0.2.143\n2 - 759 - 10.0.0.215\n')
    ...
    it('should parse application ELB logs as well', function (done) {
      exec('node dist/cli.js logs/AppELBLog.log --col2=type', function (err, stdout) {
        assert.isNull(err)
        assert.equal(stdout, '1 - 219 - http\n2 - 161 - h2\n3 - 148 - https\n4 - 71 - ws\n5 - 69 - wss\n')
        done()
      })
    })
